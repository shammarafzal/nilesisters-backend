                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group row">
                                    <label for="event_name" class="col-sm-2 col-form-label text-right">Video Title</label>
                                    <div class="col-sm">
                                        <input class="form-control" type="text" value="{{ old('title') }}" name="title" id="validatedCustomFile" placeholder="Video Title">
