                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm">
                                        <input class="form-control" type="text" value="{{ old('office_name') }}" name="office_name" id="validatedCustomFile" placeholder="Office Name">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm">
                                        <input class="form-control" type="text" value="{{ old('address') }}" name="address" id="validatedCustomFile" placeholder="Address">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm">
                                        <input class="form-control" type="text" value="{{ old('english_phone') }}" name="english_phone" id="validatedCustomFile" placeholder="English Phone">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm">
                                        <input class="form-control" type="text" value="{{ old('spanish_phone') }}" name="spanish_phone" id="validatedCustomFile" placeholder="Spanish Phone">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm">
                                        <input class="form-control" type="text" value="{{ old('email') }}" name="email" id="validatedCustomFile" placeholder="Email">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm">
                                        <input class="form-control" type="text" value="{{ old('facebook_page_1') }}" name="facebook_page_1" id="validatedCustomFile" placeholder="Facebook Page 1">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm">
                                        <input class="form-control" type="text" value="{{ old('facebook_page_2') }}" name="facebook_page_2" id="validatedCustomFile" placeholder="Facebook Page 2">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm">
                                        <input class="form-control" type="text" value="{{ old('instagram_page_1') }}" name="instagram_page_1" id="validatedCustomFile" placeholder="Instagram Page 1">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm">
                                        <input class="form-control" type="text" value="{{ old('instagram_page_2') }}" name="instagram_page_2" id="validatedCustomFile" placeholder="Instagram Page 2">
